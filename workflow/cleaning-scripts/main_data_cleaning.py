...
output:
    - data-output/standard-fields/moco-crash-2013-2018.csv
    - data-output/standard-fields/moco-crash-2003-2015.csv
"""
import sys 
...
if __name__ == "__main__":
    ...
    CLEAN_DF_03_15 = rename_df(DF_03_15,rename_dict_03_15)
